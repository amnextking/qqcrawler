...
DROP TABLE IF EXISTS qq_weibo_user;
CREATE TABLE qq_weibo_user (
user_id varchar(100) NOT NULL COMMENT '腾讯微博用户ID',
...
PRIMARY KEY (user_id)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT = '腾讯微博用户表';
